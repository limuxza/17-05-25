...
function Linux:PlaySound(soundId)
    if not Linux.SoundEnabled then return end
    spawn(function()
...
function Linux.Create(config)
    ...
    CloseButton.MouseButton1Click:Connect(function()
        Linux:Notify({Title = "UI Closed", Content = "Press LeftAlt to re-open.", Duration = 5})
        LinuxUI:Destroy()
        ToggleUI:Destroy()
    end)
    ...
    task.spawn(function()
        ...
        if DefaultTab and Tabs[DefaultTab] then
            ...
            if defaultTab.TabAccentBar then
                defaultTab.TabAccentBar.Size = UDim2.new(0, 4, 0, 24)
            end
        ...
        elseif tabOrder > 0 then
            ...
            if firstTab then
                ...
                if firstTab.TabAccentBar then
                    firstTab.TabAccentBar.Size = UDim2.new(0, 4, 0, 24)
                end
                AnimateTabSliders(1)
            end
        end
